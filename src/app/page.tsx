  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-background text-foreground">
        ...
        <section
          id="hero"
          className="relative w-full overflow-hidden pt-20 md:pt-24 pb-24 md:pb-32"
        >
          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <div className="inline-flex items-center gap-2 mb-6 md:mb-8 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 dark:from-blue-500/20 dark:via-purple-500/20 dark:to-pink-500/20 border border-blue-200/50 dark:border-blue-500/30 backdrop-blur-xl shadow-lg shadow-blue-500/10">
              ...
              <span className="text-xs md:text-sm font-semibold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
                Deploy in 60 seconds • 21+ Locations • 99.9% Uptime
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold font-headline tracking-tight mb-6 md:mb-8 leading-[1.1] px-2">
            ...
            {/* Subheadline */}
            <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 mb-8 md:mb-10 leading-relaxed font-medium px-4">
              Deploy blazing fast{" "}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 mb-8 md:mb-10 px-4">
              <Button
                asChild
                size="lg"
                className="group text-sm md:text-base px-6 md:px-10 py-5 md:py-7 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105 border-0"
              >
                <Link href="/pricing">
                  <Zap className="mr-2 size-4 md:size-5 group-hover:rotate-12 transition-transform" />
                  Start Deploying Now
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="text-sm md:text-base px-6 md:px-10 py-5 md:py-7 backdrop-blur-xl bg-white/50 dark:bg-gray-900/50 border-2 border-gray-300 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-900 hover:border-gray-400 dark:hover:border-gray-600 shadow-lg"
              >
                <Link href="#features">
                  <Globe className="mr-2 size-4 md:size-5" />
                  Explore Locations
                </Link>
              </Button>
            </div>
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center justify-center gap-x-4 md:gap-x-8 gap-y-2 md:gap-y-3 text-xs md:text-sm font-medium px-4">
              <span className="flex items-center gap-1.5 md:gap-2 text-gray-700 dark:text-gray-300">
                <div className="flex items-center justify-center w-4 md:w-5 h-4 md:h-5 rounded-full bg-green-500/20 dark:bg-green-500/30">
                  <Check className="size-2.5 md:size-3 text-green-600 dark:text-green-400 stroke-[3]" />
                </div>
                14 day money back
              </span>
              <span className="flex items-center gap-1.5 md:gap-2 text-gray-700 dark:text-gray-300">
