...
const GlobalLoader = () => {
  ...
  useEffect(() => {
    const hasLoaded = sessionStorage.getItem('initial-load');
    
    if (!hasLoaded) {
      const timer = setTimeout(() => {
        setLoading(false);
        sessionStorage.setItem('initial-load', 'true');
      }, 5000);
  ...
  useEffect(() => {
    if (sessionStorage.getItem('initial-load')) {
      setLoading(true);
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background">
      <div className="flex flex-col items-center justify-center">
        <svg width={74} height={90} viewBox="0 0 74 90" fill="none" className="animate-bounce">
          ...
          <path className="animate-pulse" d="M58 72.5L60.5 71V74L58 75.5V72.5Z" fill="#FF715E" />
          <path className="animate-pulse" style={{animationDelay: '0.2s'}} d="M63 69.5L65.5 68V71L63 72.5V69.5Z" fill="#17e300" />
          ...
          <path className="animate-pulse" d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="#FF715E" />
          ...
          <path className="animate-pulse" style={{animationDelay: '0.4s'}} d="M58 36.5L60.5 35V38L58 39.5V36.5Z" fill="#FF715E" />
          ...
          <mask id="mask0" maskUnits="userSpaceOnUse" x={11} y={51} width={14} height={11}>
            <path d="M11 52.755C11 51.9801 11.8432 51.4997 12.5098 51.8947L23.5196 58.419C24.1273 58.7792 24.5 59.4332 24.5 60.1396V60.245C24.5 61.0199 23.6568 61.5003 22.9902 61.1053L11.9804 54.581C11.3727 54.2208 11 53.5668 11 52.8604V52.755Z" fill="#396CAA" />
          </mask>
          <g mask="url(#mask0)">
          ...
          <mask id="mask1" maskUnits="userSpaceOnUse" x={19} y={9} width={38} height={23}>
            <path d="M20.1902 22.0719C18.8101 21.3026 18.8252 19.3119 20.2168 18.5636L36.1054 10.0189C37.2884 9.3827 38.7116 9.3827 39.8946 10.0189L55.7832 18.5636C57.1748 19.3119 57.1899 21.3026 55.8098 22.0719L40.4345 30.6429C38.9211 31.4865 37.0789 31.4865 35.5655 30.6429L20.1902 22.0719Z" fill="#396CAA" />
          </mask>
          <g mask="url(#mask1)">
          ...
          <path className="animate-pulse" d="M55.1521 27.1464L53.2538 26.054L55.3602 24.9661L57.2585 26.0586L55.1521 27.1464Z" fill="#3A6DAB" />
        </svg>
        <svg width={60} height={36} viewBox="0 0 60 36" fill="none" className="-mt-6 opacity-50 animate-pulse">
